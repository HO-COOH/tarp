...
bool CppProjectDirCreator::registered = 
    ProjectGenerator::registerProjectDirCreator("c", [](char const* name)->std::unique_ptr<ProjectDirCreator> {return std::make_unique<CppProjectDirCreator>(name); })
    && 
    ProjectGenerator::registerProjectDirCreator("cpp", [](char const* name)->std::unique_ptr<ProjectDirCreator> {return std::make_unique<CppProjectDirCreator>( name); });
